...
static gameswf::gc_ptr<gameswf::player> player = NULL;
static gameswf::gc_ptr<gameswf::root>	m = NULL;
...
{	
	...
	float scale_x = (float) s_width / movie_width;
	float scale_y = (float) s_height / movie_height;
...
//    m->set_display_viewport(0, 0, w, h);
